...
RUN apt-get update -qq && apt install -y -qq curl ca-certificates net-tools zip make unzip git software-properties-common jq nodejs npm zlib1g-dev libsqlite3-dev yamllint pylint tidy
