...
PTYON=(sudo git svn gpg op ssh scp ansible-vault ortpasswd otp-sha1 distro_const)
...
OCI_BUCKET_SRC_REGIONS=(us-ashburn-1 us-phoenix-1 eu-frankfurt-1 sa-saopaolo-1 ap-sydney-1)
