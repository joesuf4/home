...
alias accept_bastion_ssh_host_keys='while true; do timeout 1 yes yes | head -n 1; done | pty -nie -- $SHELL -ic "BCS_PROFILE=n/a _ec2_load_inventory; for host in \${(k)EC2_ID[@]}; ssh \$host true"'
